...
({
    ...
    baseUrl: "code-prep/jupyterterminals/",
    name: "main",
    paths: {
    ...
    out: "../build_for_pip/code-prep/build/jupyterterminals/terminals.js",
    ...
    onBuildWrite: function (moduleName, path, contents) {
        ...
        return contents.replace("define('main'", "define('nbextensions/jupyterterminals/terminals'");
    },
});
